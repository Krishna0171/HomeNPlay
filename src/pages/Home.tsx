...
export const Home: React.FC<HomeProps> = ({ onAddToCart, favorites, onToggleFavorite, onOpenChat }) => {
  ...
  const sampleReviews = [
    { userName: "Elena M.", comment: "HomeNPlay has the best curated items for my kitchen. The precision scale is a game changer for my weekend baking.", rating: 5 },
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20 animate-in fade-in duration-700">
      {/* Hero Section */}
      <section className="relative h-[500px] sm:h-[550px] overflow-hidden bg-slate-900 flex items-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-white max-w-4xl w-full">
          ...
          <h1 className="text-3xl sm:text-6xl font-extrabold mb-6 leading-tight">
            “Everything your home needs to <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-emerald-400">feel like family.</span>”
          </h1>
          ...
          <div className="flex flex-col gap-4 w-full sm:flex-row sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-indigo-500/20 flex items-center justify-center group"
            >
      ...
      <div className="container mx-auto px-4 sm:px-6 -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          {[
            { icon: <Zap className="text-indigo-500" />, title: 'Next-Day Delivery', desc: 'Orders over ₹500 ship fast.' },
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`px-5 py-2 rounded-full text-xs font-bold transition-all border ${activeCategory === 'All'
        ...
        <div className="bg-slate-900 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-16 relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="relative z-10 max-w-xl text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <button
                onClick={() => navigate('/contact')} className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-slate-900 font-bold rounded-2xl hover:bg-slate-50 transition-all flex items-center shadow-xl shadow-black/20"
              >
